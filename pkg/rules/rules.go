...
func Register(reg *lint.Registrar) {
	...
	reg.MustRegister(maintainability.BooleanName{})
	...
	reg.MustRegister(maintainability.RedundantElse{})
	reg.MustRegister(maintainability.MagicValue{})
	...
	reg.MustRegister(correctness.NarrowingConversion{})
	...
	reg.MustRegister(openmp.FormatArgumentTag{})
	...
	reg.MustRegister(openmp.ReadAfterRelease{})
	...
	reg.MustRegister(correctness.ConflictingIncludeSymbol{})
