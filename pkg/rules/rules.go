...
func Register(reg *lint.Registrar) {
	...
	reg.MustRegister(correctness.MissingInclude{})
	reg.MustRegister(correctness.AmbiguousInclude{})
	reg.MustRegister(correctness.DuplicateInclude{})
	reg.MustRegister(correctness.ForbiddenInclude{})
	reg.MustRegister(correctness.UnusedInclude{})
	reg.MustRegister(correctness.IncludeLayering{})
