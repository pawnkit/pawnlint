...
func validatePreset(path string, file File) error {
	if file.Target != "" || file.Include != nil || file.Exclude != nil || file.Defines != nil || file.IncludePaths != nil || file.APIMetadata != nil || file.Baseline != "" || file.Cache != "" || file.Builds != nil || file.Variants != nil || file.ExternalRules != nil {
...
func mergePreset(base, override File) File {
	...
	result.ExternalRules = append([]ExternalRule(nil), override.ExternalRules...)
