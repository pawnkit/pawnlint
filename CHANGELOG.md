...
- Cache shared diagnostic file mappings and line indexes during one lint run.
...
- Cache enclosing-function lookups shared by lint rules.
...
- Use pawn-analysis v0.30.16 and pawn-parser v1.5.11.
...
- Use pawn-analysis v0.30.14.

## 1.8.35 - 2026-08-03

### Changed

- Use pawn-analysis v0.30.13 and pawn-parser v1.5.10.
...
- Resolve PawnPlus tag aliases through pawn-analysis.
...
- Reuse rule IDs and token indexes across a lint pass.
...
- Use pawn-analysis 0.30.3 so trivia-only editor edits reuse stable analysis.
